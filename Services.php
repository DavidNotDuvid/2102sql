...
echo '<link rel="stylesheet" type="text/css" href="css/services.css">';
echo '</head>';
echo '';
echo '<body>';
...
echo '<button type="next" class="Seemorebtn">See More</button>';
echo '<button type="next" class="Publishbtn">Publish</button>';
echo '</div>';
echo '</div>';
echo '';
echo '<p> </p>';
...
echo '<h1>';
echo '<div class="clearfix">';
echo '<button type="next" class="Addpetbtn">Add Service</button></div>';
echo '</h1>';
echo '';
echo '</body>';
echo '</html>';
